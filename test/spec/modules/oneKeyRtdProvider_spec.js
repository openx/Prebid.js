...
import {setData, getBidRequestData, oneKeyDataSubmodule} from 'modules/oneKeyRtdProvider.js';
import {getAdUnits} from '../../fixtures/fixtures.js';

describe('oneKeyRtdProvider', function() {
  beforeEach(function() {
    config.resetConfig();
  });

  describe('oneKeyDataSubmodule', function() {
